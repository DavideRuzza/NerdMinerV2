...
void custom0_Display_Init(void)
{
  tft.init();
...
void custom0_Display_AlternateScreenState(void)
{
...
void custom0_Display_AlternateRotation(void)
{
  tft.setRotation(flipRotation(tft.getRotation()) );
}

void custom0_Display_MinerScreen(unsigned long mElapsed)
{
...
void custom0_Display_ClockScreen(unsigned long mElapsed)
{
...
void custom0_Display_GlobalHashScreen(unsigned long mElapsed)
{

}

void custom0_Display_LoadingScreen(void)
{
...
void custom0_Display_SetupScreen(void)
{
  tft.pushImage(0, 0, setupModeWidth, setupModeHeight, setupModeScreen);
}

void custom0_Display_AnimateCurrentScreen(unsigned long frame)
{
}

void custom0_Display_DoLedStuff(unsigned long frame)
{
}

CyclicScreenFunction custom0_DisplayCyclicScreens[] = {custom0_Display_MinerScreen, custom0_Display_ClockScreen};

DisplayDriver custom0_DisplayDriver = {
    custom0_Display_Init,
    custom0_Display_AlternateScreenState,
    custom0_Display_AlternateRotation,
    custom0_Display_LoadingScreen,
    custom0_Display_SetupScreen,
    custom0_DisplayCyclicScreens,
    custom0_Display_AnimateCurrentScreen,
    custom0_Display_DoLedStuff,
    SCREENS_ARRAY_SIZE(custom0_DisplayCyclicScreens),
    0,
    WIDTH,
    HEIGHT};
#endif
